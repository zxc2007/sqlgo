...
from sqlmap.lib.core.exception import SqlmapInstallationException
from sqlmap.lib.core.settings import PAYLOAD_XML_FILES
...
from sqlmap.extra.beep.beep import beep
from sqlmap.extra.cloak.cloak import decloak
from sqlmap.lib.core.bigarray import BigArray
from sqlmap.lib.core.compat import cmp
from sqlmap.lib.core.compat import LooseVersion
from sqlmap.lib.core.compat import round
from sqlmap.lib.core.compat import xrange
from sqlmap.lib.core.convert import base64pickle
from sqlmap.lib.core.convert import base64unpickle
from sqlmap.lib.core.convert import decodeBase64
...
from sqlmap.lib.core.convert import stdoutEncode
from sqlmap.lib.core.data import cmdLineOptions
from sqlmap.lib.core.data import conf
...
from sqlmap.lib.core.decorators import cachedmethod
from sqlmap.lib.core.defaults import defaults
from sqlmap.lib.core.dicts import DBMS_DICT
from sqlmap.lib.core.dicts import DEFAULT_DOC_ROOTS
from sqlmap.lib.core.dicts import DEPRECATED_OPTIONS
from sqlmap.lib.core.dicts import OBSOLETE_OPTIONS
from sqlmap.lib.core.dicts import SQL_STATEMENTS
from sqlmap.lib.core.enums import ADJUST_TIME_DELAY
from sqlmap.lib.core.enums import CHARSET_TYPE
from sqlmap.lib.core.enums import CONTENT_STATUS
...
from sqlmap.lib.core.enums import HEURISTIC_TEST
from sqlmap.lib.core.enums import HTTP_HEADER
from sqlmap.lib.core.enums import HTTPMETHOD
from sqlmap.lib.core.enums import LOGGING_LEVELS
from sqlmap.lib.core.enums import MKSTEMP_PREFIX
from sqlmap.lib.core.enums import OPTION_TYPE
from sqlmap.lib.core.enums import OS
from sqlmap.lib.core.enums import PAYLOAD
from sqlmap.lib.core.enums import PLACE
from sqlmap.lib.core.enums import POST_HINT
from sqlmap.lib.core.enums import REFLECTIVE_COUNTER
from sqlmap.lib.core.enums import SORT_ORDER
from sqlmap.lib.core.exception import SqlmapBaseException
from sqlmap.lib.core.exception import SqlmapDataException
from sqlmap.lib.core.exception import SqlmapGenericException
from sqlmap.lib.core.exception import SqlmapInstallationException
...
from sqlmap.lib.core.exception import SqlmapSilentQuitException
from sqlmap.lib.core.exception import SqlmapSyntaxException
from sqlmap.lib.core.exception import SqlmapSystemException
from sqlmap.lib.core.exception import SqlmapUserQuitException
from sqlmap.lib.core.exception import SqlmapValueException
from sqlmap.lib.core.log import LOGGER_HANDLER
from sqlmap.lib.core.optiondict import optDict
from sqlmap.lib.core.settings import BANNER
from sqlmap.lib.core.settings import BOLD_PATTERNS
from sqlmap.lib.core.settings import BOUNDARY_BACKSLASH_MARKER
from sqlmap.lib.core.settings import BOUNDED_INJECTION_MARKER
from sqlmap.lib.core.settings import BRUTE_DOC_ROOT_PREFIXES
from sqlmap.lib.core.settings import BRUTE_DOC_ROOT_SUFFIXES
from sqlmap.lib.core.settings import BRUTE_DOC_ROOT_TARGET_MARK
from sqlmap.lib.core.settings import BURP_REQUEST_REGEX
from sqlmap.lib.core.settings import BURP_XML_HISTORY_REGEX
from sqlmap.lib.core.settings import CRAWL_EXCLUDE_EXTENSIONS
from sqlmap.lib.core.settings import CUSTOM_INJECTION_MARK_CHAR
from sqlmap.lib.core.settings import DBMS_DIRECTORY_DICT
from sqlmap.lib.core.settings import DEFAULT_COOKIE_DELIMITER
from sqlmap.lib.core.settings import DEFAULT_GET_POST_DELIMITER
from sqlmap.lib.core.settings import DEFAULT_MSSQL_SCHEMA
from sqlmap.lib.core.settings import DEV_EMAIL_ADDRESS
from sqlmap.lib.core.settings import DOLLAR_MARKER
from sqlmap.lib.core.settings import DUMMY_USER_INJECTION
from sqlmap.lib.core.settings import DYNAMICITY_BOUNDARY_LENGTH
from sqlmap.lib.core.settings import ERROR_PARSING_REGEXES
from sqlmap.lib.core.settings import EVALCODE_ENCODED_PREFIX
from sqlmap.lib.core.settings import FILE_PATH_REGEXES
from sqlmap.lib.core.settings import FORCE_COOKIE_EXPIRATION_TIME
from sqlmap.lib.core.settings import FORM_SEARCH_REGEX
from sqlmap.lib.core.settings import GENERIC_DOC_ROOT_DIRECTORY_NAMES
from sqlmap.lib.core.settings import GIT_PAGE
from sqlmap.lib.core.settings import GITHUB_REPORT_OAUTH_TOKEN
from sqlmap.lib.core.settings import GOOGLE_ANALYTICS_COOKIE_PREFIX
from sqlmap.lib.core.settings import HASHDB_MILESTONE_VALUE
from sqlmap.lib.core.settings import HOST_ALIASES
from sqlmap.lib.core.settings import HTTP_CHUNKED_SPLIT_KEYWORDS
from sqlmap.lib.core.settings import IGNORE_PARAMETERS
from sqlmap.lib.core.settings import IGNORE_SAVE_OPTIONS
from sqlmap.lib.core.settings import INFERENCE_UNKNOWN_CHAR
from sqlmap.lib.core.settings import IP_ADDRESS_REGEX
from sqlmap.lib.core.settings import ISSUES_PAGE
from sqlmap.lib.core.settings import IS_TTY
from sqlmap.lib.core.settings import IS_WIN
from sqlmap.lib.core.settings import LARGE_OUTPUT_THRESHOLD
from sqlmap.lib.core.settings import LOCALHOST
from sqlmap.lib.core.settings import MAX_INT
from sqlmap.lib.core.settings import MIN_ENCODED_LEN_CHECK
from sqlmap.lib.core.settings import MIN_ERROR_PARSING_NON_WRITING_RATIO
from sqlmap.lib.core.settings import MIN_TIME_RESPONSES
from sqlmap.lib.core.settings import MIN_VALID_DELAYED_RESPONSE
from sqlmap.lib.core.settings import NETSCAPE_FORMAT_HEADER_COOKIES
from sqlmap.lib.core.settings import NULL
from sqlmap.lib.core.settings import PARAMETER_AMP_MARKER
from sqlmap.lib.core.settings import PARAMETER_SEMICOLON_MARKER
from sqlmap.lib.core.settings import PARAMETER_PERCENTAGE_MARKER
from sqlmap.lib.core.settings import PARTIAL_HEX_VALUE_MARKER
from sqlmap.lib.core.settings import PARTIAL_VALUE_MARKER
from sqlmap.lib.core.settings import PAYLOAD_DELIMITER
from sqlmap.lib.core.settings import PLATFORM
from sqlmap.lib.core.settings import PRINTABLE_CHAR_REGEX
from sqlmap.lib.core.settings import PROBLEMATIC_CUSTOM_INJECTION_PATTERNS
from sqlmap.lib.core.settings import PUSH_VALUE_EXCEPTION_RETRY_COUNT
from sqlmap.lib.core.settings import PYVERSION
from sqlmap.lib.core.settings import RANDOMIZATION_TLDS
from sqlmap.lib.core.settings import REFERER_ALIASES
from sqlmap.lib.core.settings import REFLECTED_BORDER_REGEX
from sqlmap.lib.core.settings import REFLECTED_MAX_REGEX_PARTS
from sqlmap.lib.core.settings import REFLECTED_REPLACEMENT_REGEX
from sqlmap.lib.core.settings import REFLECTED_REPLACEMENT_TIMEOUT
from sqlmap.lib.core.settings import REFLECTED_VALUE_MARKER
from sqlmap.lib.core.settings import REFLECTIVE_MISS_THRESHOLD
from sqlmap.lib.core.settings import SENSITIVE_DATA_REGEX
from sqlmap.lib.core.settings import SENSITIVE_OPTIONS
from sqlmap.lib.core.settings import STDIN_PIPE_DASH
from sqlmap.lib.core.settings import SUPPORTED_DBMS
from sqlmap.lib.core.settings import TEXT_TAG_REGEX
from sqlmap.lib.core.settings import TIME_STDEV_COEFF
from sqlmap.lib.core.settings import UNICODE_ENCODING
from sqlmap.lib.core.settings import UNKNOWN_DBMS_VERSION
from sqlmap.lib.core.settings import URI_QUESTION_MARKER
from sqlmap.lib.core.settings import URLENCODE_CHAR_LIMIT
from sqlmap.lib.core.settings import URLENCODE_FAILSAFE_CHARS
from sqlmap.lib.core.settings import USER_AGENT_ALIASES
from sqlmap.lib.core.settings import VERSION_COMPARISON_CORRECTION
from sqlmap.lib.core.settings import VERSION_STRING
from sqlmap.lib.core.settings import ZIP_HEADER
from sqlmap.lib.core.settings import WEBSCARAB_SPLITTER
...
from sqlmap.thirdparty.six.moves import collections_abc as _collections
...
class Backend(object):
    ...
    def getErrorParsedDBMSes():
        ...
        1. Ask user whether or not skip specific DBMS tests in detection phase,
           sqlmap.lib/controller/checks.py - detection phase.
        2. Sort the fingerprint of the DBMS, sqlmap.lib/controller/handler.py -
           fingerprint phase.
        """
...
def setPaths(rootPath):
    ...
    paths.SQLMAP_EXTRAS_PATH = os.path.join(paths.SQLMAP_ROOT_PATH, "sqlmap.extra")
    paths.SQLMAP_SETTINGS_PATH = os.path.join(paths.SQLMAP_ROOT_PATH, "sqlmap.lib", "core", "settings.py")
...
def getLatestRevision():
    ...
    retVal = None
    req = _urllib.request.Request(url="https://raw.githubusercontent.com/sqlmapproject/sqlmap/master/sqlmap.lib/core/settings.py", headers={HTTP_HEADER.USER_AGENT: fetchRandomAgent()})
